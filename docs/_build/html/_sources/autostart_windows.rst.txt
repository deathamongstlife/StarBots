...
.. code-block:: batch
    ...
    python -O -m starbot <your instance name>
...
Click "File", "Save as". Change the dropdown "Save as type" to "All Files (*.*)". Set the filename to ``start_starbot.bat``, and click save.
...
You can now use the ``start_starbot.bat`` batch file to launch Red by double clicking it.
...
Create a shortcut of your ``start_starbot.bat`` file.
