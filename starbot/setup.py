...
from starbot.core._cli import confirm
from starbot.core.utils._internal_utils import (
    safe_delete,
    create_backup as red_create_backup,
    cli_level_to_log_level,
)
from starbot.core import config, data_manager, _drivers
from starbot.core._cli import ExitCodes
from starbot.core.data_manager import appdir, config_dir, config_file
from starbot.core._drivers import BackendType, IdentifierData
...
def basic_setup(
    *,
    ...
    if interactive:
        print()
        print(
            f"Your basic configuration has been saved. Please run `starbot {name}` to"
