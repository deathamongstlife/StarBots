...
import starbot.logging
from starbot import __version__
from starbot.core.bot import Red, ExitCodes, _NoOwnerSet
from starbot.core._cli import interactive_config, confirm, parse_cli_flags
from starbot.setup import get_data_dir, get_name, save_config
from starbot.core import data_manager, _drivers
from starbot.core._debuginfo import DebugInfo
from starbot.core._sharedlibdeprecation import SharedLibImportWarner


log = logging.getLogger("starbot.main")
...
def list_instances():
    if not data_manager.config_file.exists():
        print(
            ...
            "using `starbot-setup` before trying to run the bot!"
        )
...
async def run_bot(red: Red, cli_flags: Namespace) -> None:
    ...
    try:
        ...
        print(
            ...
            f"b) set owner manually with `starbot --edit {cli_flags.instance_name}`\n"
