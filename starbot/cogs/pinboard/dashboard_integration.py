...
_ = Translator("pinboard", __file__)
...
class DashboardIntegration:
    ...
    @dashboard_page(name=None, description="Manage pinboard")
    async def dashboard_main(self, **kwargs) -> None:
        return {"status": 0, "web_content": {"source": '<h1>pinboard Dashboard</h1><p>Welcome to the pinboard dashboard!</p>'}}
