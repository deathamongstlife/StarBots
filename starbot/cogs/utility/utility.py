...
from starbot.core.utils.chat_formatting import bold, box, error, escape, info, inline
...
class Utility(Cog, Raffles, Polls, Events, metaclass=CompositeMetaClass):
    ...
    def __init__(self, bot: Red):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("Utility")
        self.bot = bot
