...
from starbot import VersionInfo, version_info
from starbot.core import Config, checks, commands
from starbot.core.i18n import Translator, cog_i18n
from starbot.core.utils.chat_formatting import humanize_list, humanize_timedelta, pagify
...
class EventPoster(Cog):
    ...
    def __init__(self, bot):
        ...
        self.logs = CogsUtils.get_logger("EventPoster")
