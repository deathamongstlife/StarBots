...
from starbot.core.config import Group
from starbot.core.utils.angiedale import inkopolis_invite, patreons_in_tier
...
from starbot.core.utils.common_filters import (
...
class General(Reports, Cog):
    ...
    def __init__(self, bot: Red) -> None:
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("General")
        self.logs = CogsUtils.get_logger("General")
        self.logs = CogsUtils.get_logger("General")
        self.logs = CogsUtils.get_logger("General")
        self.bot = bot
