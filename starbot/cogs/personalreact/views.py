    ...
    async def get_embed(self) -> discord.Embed:
        ...
        embed.add_field(
            ...
            value=(
                ...
                + (_("\n**{action} {base_total_amount}** Always Allow").format(action="+" if base_use_amounts_sum else "•", base_total_amount=base_total_amount) if always_allow_custom_trigger and base_total_amount > 0 else "")
...
class AddReactionsModal(discord.ui.Modal):
    def __init__(self, cog: Cog, ctx: commands.Context, parent_view: discord.ui.View, view: discord.ui.View) -> None:
        self.ctx: commands.Context = ctx
        self.cog: Cog = cog
        self.parent_view: discord.ui.View = parent_view
...
class ReactionsView(discord.ui.View):
    def __init__(self, cog: Cog, ctx: commands.Context, parent_view: discord.ui.View) -> None:
...
class RolesView(discord.ui.View):
    def __init__(self, cog: Cog, ctx: commands.Context, settings_view: SettingsView, _type: typing.Literal["base", "custom_trigger"]) -> None:
        super().__init__(timeout=60)
        self.ctx: commands.Context = ctx
        self.cog: Cog = cog
