...
from starbot.cogs.warnings.helpers import (
    warning_points_add_check,
    get_command_for_exceeded_points,
    get_command_for_dropping_points,
    warning_points_remove_check,
)
from starbot.core import Config, commands, modlog
from starbot.core.bot import Red
from starbot.core.commands import UserInputOptional, RawUserIdConverter
...
from starbot.core.utils.chat_formatting import warning, pagify
