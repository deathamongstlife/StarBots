...
from starbot.core.utils.chat_formatting import humanize_number, humanize_timedelta, pagify
...
class Unbelievaboat(Wallet, Roulette, SettingsMixin, Cog, metaclass=CompositeMetaClass):
    ...
    def __init__(self, bot):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("Unbelievaboat")
        self.logs = CogsUtils.get_logger("Unbelievaboat")
        self.bot = bot
        defaults = {
            "cooldowns": {
