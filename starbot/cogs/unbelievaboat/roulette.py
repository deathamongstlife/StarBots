...
import discord
import tabulate
from starbot.core import bank, checks, commands
from starbot.core.errors import BalanceTooHigh
from starbot.core.utils.chat_formatting import box, humanize_number, humanize_timedelta
...
class Roulette(MixinMeta):
    def __init__(self, bot):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("Roulette")
    """Roulette Game."""
