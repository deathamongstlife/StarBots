...
_ = Translator("antilinks", __file__)
...
class DashboardIntegration:
    ...
    @dashboard_page(name=None, description="Manage antilinks")
    async def dashboard_main(self, **kwargs) -> None:
        return {"status": 0, "web_content": {"source": '<h1>antilinks Dashboard</h1><p>Welcome to the antilinks dashboard!</p>'}}
