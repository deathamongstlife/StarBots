...
from starbot.core import dev_commands
from starbot.core.utils.chat_formatting import bold, box
...
class WhatIsConverter(commands.Converter):
    def __init__(self, bot):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("WhatIsConverter")
        self.logs = CogsUtils.get_logger("WhatIsConverter")
        self.logs = CogsUtils.get_logger("WhatIsConverter")
        self.logs = CogsUtils.get_logger("WhatIsConverter")
        self.logs = CogsUtils.get_logger("CtxVar")
