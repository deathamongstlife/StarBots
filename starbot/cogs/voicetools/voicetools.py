...
from starbot.core.utils import AsyncIter, menus
...
class VoiceTools(Cog):
    """Various tools to make voice channels better!"""

    def __init__(self, bot: Red) -> None:
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("VoiceTools")
        self.logs = CogsUtils.get_logger("VoiceTools")
        self.bot = bot
    ...
    async def cog_disabled_in_guild(self, guild: Optional[discord.Guild]) -> bool:
        ...
        func: Optional[
            Callable[[Cog, Optional[discord.Guild]], Awaitable[bool]]
