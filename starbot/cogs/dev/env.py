...
from starbot.core import Config, dev_commands
from starbot.core import utils as redutils
...
class DevEnv(typing.Dict[str, typing.Any]):
    ...
    def __missing__(self, key: str) -> typing.Any:
        ...
        if (attr := getattr(cf, key, None)) is not None:
            self.imported.append(("starbot.core.utils.chat_formatting", key))
            self[key] = attr
            return attr
        try:
