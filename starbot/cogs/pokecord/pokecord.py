...
from starbot.core.i18n import Translator, cog_i18n, set_contextual_locales_from_guild
from starbot.core.utils.chat_formatting import escape, humanize_list
...
class Pokecord(
    ...
    def __init__(self, bot):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("CompositeMetaClass")
        self.logs = CogsUtils.get_logger("CompositeMetaClass")
        self.logs = CogsUtils.get_logger("CompositeMetaClass")
        self.logs = CogsUtils.get_logger("CompositeMetaClass")
        self.bot = bot
