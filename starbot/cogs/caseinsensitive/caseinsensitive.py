...
from starbot.cogs.alias.alias_entry import AliasCache, AliasEntry
...
class CaseInsensitive(Cog):
    ...
    def plug_alias(self) -> None:
        ...
        alias_cog: Optional[Cog] = self.bot.get_cog("Alias")
    ...
    async def on_cog_add(self, cog: Cog):
