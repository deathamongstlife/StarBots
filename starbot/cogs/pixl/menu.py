...
async def menu(
    ...
    if not isinstance(pages[0], discord.Embed):
        raise RuntimeError("Pages must be of type discord.Embed")
    if not all(isinstance(x, discord.Embed) for x in pages):
