...
import asyncio
import discord
from starbot.core import Config, checks, commands, data_manager
from starbot.core.bot import Red
from starbot.core.commands.context import Context
from starbot.core.utils import AsyncIter, chat_formatting
...
class SmartReact(Cog):
    ...
    @commands.commands.Cog.listener("on_guild_emojis_update")
    ...
    # "more Pythonic"
    @commands.commands.Cog.listener("on_message")
