...
from starbot.core.utils import AsyncIter, deduplicate_iterables, mod
from starbot.core.utils.chat_formatting import humanize_list, pagify, quote
from starbot.core.utils.common_filters import filter_invites
...
if TYPE_CHECKING:
    ...
    from starbot.cogs.filter import Filter
...
class Rift(Cog):
    ...
    def __init__(self, bot: Red):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("Rift")
        self.bot = bot
