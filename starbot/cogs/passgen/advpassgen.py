...
class Passgen(Cog):
    ...
    async def passgen(self, ctx):
        ...
        try:
            ...
            buttons = [
                discord.ui.Button(style=discord.ButtonStyle.blue, label=str(i), custom_id=f"passgen_length_{i}") 
                for i in range(6, 33)
            ]
            ...
            buttons = [
                discord.ui.Button(style=discord.ButtonStyle.green, label="Basic Symbols", custom_id="passgen_basic"),
                discord.ui.Button(style=discord.ButtonStyle.red, label="Advanced Symbols", custom_id="passgen_advanced"),
            ]
