...
import starbot.cogs
from starbot.core.commands import positive_int
from starbot.core.utils import deduplicate_iterables
...
class CogManager:
    ...
    CORE_PATH = Path(starbot.cogs.__path__[0]).resolve()
