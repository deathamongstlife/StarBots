...
from starbot.core.bot import ExitCodes
from starbot.core.commands import RedHelpFormatter, HelpSettings
from starbot.core.i18n import (
    Translator,
...
def init_events(bot, cli_flags):
    ...
    async def _on_ready():
        ...
        if not guilds:
            rich_console.print(
                f"Looking for a quick guide on setting up starbot? Contact death_waffle on Discord for assistance!"
            )
        bot._red_ready.set()
