...
from starbot.core import app_commands, data_manager
from starbot.core.utils.menus import menu
from starbot.core.utils.views import _StopButton, InviteView, SetApiView, View
from starbot.core.commands import GuildConverter, RawUserIdConverter
...
from starbot.core.data_manager import storage_type
...
class CoreLogic:
    ...
    async def _version_info(cls) -> Dict[str, str]:
        ...
        -------
        dict
            `starbot` and `discordpy` keys containing version information for both.
        """
        return {"starbot": __version__, "discordpy": discord.__version__}
...
class Core(commands.commands._RuleDropper, commands.Cog, CoreLogic):
    ...
    async def mydata_3rd_party(self, ctx: commands.Context):
        ...
        **Example:**
        ...
        statements = {
            ...
            if not (ext.__package__ and ext.__package__.startswith("starbot."))
        }
    ...
    async def datapath(self, ctx: commands.Context):
        ...
        from starbot.core.data_manager import basic_config
