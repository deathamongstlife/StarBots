...
def get_version_to_release() -> str:
    import starbot  # this needs to be imported after proper branch is checked out

    version_info = starbot.VersionInfo.from_str(starbot._VERSION)
...
def create_changelog(release_type: ReleaseType, version: str) -> None:
    ...
    if release_type is ReleaseType.HOTFIX:
        rich.print(
            ...
            " for example see:"
            " [link=https://docs.discord.red/en/stable/changelog.html#starbot-3-4-12-2021-06-17]"
